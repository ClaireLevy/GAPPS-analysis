...
folderPath<-"..\\GAPPS 2015 Neutrophils\\CyToF\\data and analysis\\fcs and compiled flowjo\\normed live export"
...
################### TRYING read.flowSet ######################
#This only works if you have full.names=TRUE

# fs2<-read.flowSet(dir(folderPath, pattern = "\\.fcs", full.names = TRUE),
...
#for scale colour gradient("value, colours=topo.colors(7))