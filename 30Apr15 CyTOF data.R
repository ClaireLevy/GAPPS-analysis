...
#read in counts data
countsTable<-read.csv("../April-May 2015 HVTN cytobrush CyToF testing/April-May 2015 raw CyToF data/counts2.csv")

#read in frequency data

freqTable<-read.csv("../April-May 2015 HVTN cytobrush CyToF testing/April-May 2015 raw CyToF data/frequency1.csv")
...
#save for shiny
save(freqMeltStackedBar,file="freqMeltStackedBar.Rda")
